...
public class MemberCourseController {
    ...
    public static final String BUSINESS_NAME = "成员课程报名表";
    ...
    public ResponseDto save(@RequestBody MemberCourseDto memberCourseDto) {
        ...
        ValidatorUtil.require(memberCourseDto.getCourseId(), "验证码");
        ValidatorUtil.length(memberCourseDto.getCourseId(), "验证码", 1, 8);
