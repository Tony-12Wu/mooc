...
public class VodUtil {
    ...
    public static DefaultAcsClient initVodClient(String accessKeyId, String accessKeySecret) throws ClientException {
        // 点播服务接入区域，国内请填cn-shenzhen，其他区域请参考文档[点播中心](~~98194~~)
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient, String fileName) throws ClientException {
        ...
        // 分类id
        //request.setCateId(1553L);
        request.setTemplateGroupId("d21e9dbc74361dea31a70ab670484b4f");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tBw45ueJZzGKRsea9Lb";
        //您的AccessKeySecret
        String accessKeySecret = "ZngmpgCy0DMqRgF447TkzKaXfujDRi";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\毕设\\mooc\\mooc\\admin\\public\\static\\image\\小节视频test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
